...
__all__ = [ 'OLE_YPOS_CONTAINER', 'Default', 'OLE_XSIZE_HIMETRIC',
           'Checked', 'Picture', 'Font', 'OLE_HANDLE',
           'OLE_XPOS_PIXELS', 'StdPicture', 'Monochrome',
           'LoadPictureConstants', 'OLE_ENABLEDEFAULTBOOL',
           'FONTSIZE', 'OLE_XPOS_HIMETRIC', 'OLE_XPOS_CONTAINER',
           'OLE_YSIZE_PIXELS', 'OLE_TRISTATE', 'OLE_YSIZE_CONTAINER',
           'OLE_XSIZE_CONTAINER', 'FONTITALIC', 'IPictureDisp',
           'OLE_YSIZE_HIMETRIC', 'OLE_YPOS_PIXELS', 'IFont', 'Gray',
           'OLE_OPTEXCLUSIVE', 'OLE_COLOR', 'StdFont', 'VgaColor',
           'Color', 'OLE_YPOS_HIMETRIC', 'IPicture',
           'OLE_XSIZE_PIXELS', 'FONTUNDERSCORE', 'OLE_CANCELBOOL',
           'IFontDisp', 'Unchecked', 'FONTBOLD', 'IFontEventsDisp',
